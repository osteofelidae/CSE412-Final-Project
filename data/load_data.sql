...
copy Artist from 'data/spotify-top-artists-by-monthly-listeners/Artist.csv' delimiter ',' csv header;

-- song table
CREATE TABLE Song (song_id INT, Name varchar(255), Genre varchar(255), Explicit varchar(255) );

copy Song from './spotify-tracks-dataset/Song.csv' delimiter ',' csv header;
...
copy YouTubeVideo from './spotify-and-youtube/YoutubeVideo.csv' delimiter ',' csv header;

-- creates table
CREATE TABLE Creates ( artist_id INT, song_id INT );

copy Creates from './spotify-tracks-dataset/Creates.csv' delimiter ',' csv header;
